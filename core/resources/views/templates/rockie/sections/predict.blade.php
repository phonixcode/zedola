    ...
    <div class="container">
        <div class="row">
            ...
            @foreach ($elements as $element)
                <div class="col-md-4">
                    <div class="main">
                        <span class="predictModelShow" data-predict='@json(@$element->data_values)'>
                            <h6> @php echo @$element->data_values->icon @endphp</h6>
                ...
                <div class="predict-type-content">
                    ...
                    <div class="pt-2 d-flex flex-wrap couple--buttons">
                        <a href="{{ route('user.register') }}"
                            class="cmn--btn btn-name">{{ __(@$value->data_values->button_name) }}</a>
