...
use App\Http\Controllers\User\PractiseTradeController;
...
Route::prefix('user')->group(function() {
    ...
    Route::group(['middleware'=>'kyc:Practise Trade'],function(){
        Route::get('/practise-trade/method', [PractiseTradeController::class,'tradeMethod'])->name('user.practise.trade.method');
        Route::get('/practise-trade/{slug}', [PractiseTradeController::class,'index'])->name('user.practise.trade.method.name');
        Route::post('/practise-trade', [PractiseTradeController::class,'trade'])->name('user.practise.trade.store');
        Route::get('/practise/trade/logs', [PractiseTradeController::class,'tradeLogs'])->name('user.practise.trade.logs');
        Route::post('/add/practise-balance', [PractiseTradeController::class,'addBalance'])->name('user.add.practise.balance');
    });

    Route::group(['middleware'=>'kyc:Trade'],function(){
      Route::get('/trade/method', [TradeController::class,'tradeMethod'])->name('user.trade.method');
      Route::get('/trade/{slug}', [TradeController::class,'index'])->name('user.trade.method.name');
      Route::post('/trade', [TradeController::class,'trade'])->name('user.trade.store');
      Route::get('/crypto/trade/logs', [TradeController::class,'tradeLogs'])->name('user.trade.logs');
    });
    ...
    Route::group(['middleware'=>'kyc:Deposits & Payouts'],function(){
      ...
      Route::group(['middleware'=>'kyc:Referral'],function(){
