        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block-text center">
                    ...
                    <p class="desc fs-20 mb-3">{{ __(@$content->data_values->sub_heading) }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="crypto__main">
                    <div class="flat-tabs">
                        <ul class="menu-tab">
                            <li class="active">
                                <h6 class="fs-16">{{ __(@$content->data_values->trade_tab_1) }}</h6>
                            </li>
                            <li>
                                <h6 class="fs-16">{{ __(@$content->data_values->trade_tab_2) }}</h6>
                            </li>
                        </ul>
