    ...
    <div class="dashboard-sidebar-inner">
        ...
        <div class="user-sidebar-body">
            <ul class="user-sidbar-link">
                ...
                <li>
                    <span class="subtitle">@lang('Practise Trade')</span>
                </li>

                <li>
                    <a href="{{ route('user.practise.trade.method') }}" class="{{ request()->routeIs('user.practise.trade.method') ? 'active' : ''}}">
                ...
                <li>
                    <a href="{{ route('user.practise.trade.logs') }}" class="{{ request()->routeIs('user.practise.trade.logs') ? 'active' : ''}}">
                ...
                <li>
                    <span class="subtitle">@lang('Trade')</span>
                </li>
                <li>
                    <a href="{{ route('user.trade.method') }}" class="{{ request()->routeIs('user.trade.method') ? 'active' : ''}}">
                        <span class="icon"><i class="fas fa-stream"></i></span>
                        @lang('Trade Now')
                    </a>
                </li>
                <li>
                    <a href="{{ route('user.trade.logs') }}" class="{{ request()->routeIs('user.trade.logs') ? 'active' : ''}}">
                        <span class="icon"><i class="fas fa-history"></i></span>
                        @lang('Trade Log')
                    </a>
                </li>
                ...
                <li>
                    <span class="subtitle">@lang('Deposits & Payouts')</span>
                </li>
