...
use App\Http\Controllers\Admin\PractiseTradeLogController;
...
use App\Http\Controllers\Admin\TradeMethodController;
use App\Http\Controllers\Admin\TradeScheduleController;
...
Route::prefix('admin')->group(function(){
    ...
    Route::get('/cache/clear', function() {
      ...
      Route::group(['middleware'=>'permissions:Referral'],function(){
      ...
      Route::group(['middleware'=>'permissions:Trade'],function(){
        Route::get('/trade/schedule/datatables', [TradeScheduleController::class,'datatables'])->name('admin.schedule.datatables');
        Route::get('/trade/schedule', [TradeScheduleController::class,'index'])->name('admin.schedule.index');
        Route::get('/trade/schedule/create', [TradeScheduleController::class,'create'])->name('admin.schedule.create');
        Route::get('/trade/schedule/edit/{id}', [TradeScheduleController::class,'edit'])->name('admin.schedule.edit');
        Route::post('/trade/schedule/create', [TradeScheduleController::class,'store'])->name('admin.schedule.store');
        Route::post('/trade/schedule/update/{id}', [TradeScheduleController::class,'update'])->name('admin.schedule.update');
        Route::get('/trade/schedule/delete/{id}', [TradeScheduleController::class,'destroy'])->name('admin.schedule.delete');

        Route::get('/trade/method/datatables', [TradeMethodController::class,'datatables'])->name('admin.method.datatables');
        Route::get('/trade/method', [TradeMethodController::class,'index'])->name('admin.method.index');
        Route::get('/trade/method/create', [TradeMethodController::class,'create'])->name('admin.method.create');
        Route::get('/trade/method/edit/{id}', [TradeMethodController::class,'edit'])->name('admin.method.edit');
        Route::post('/trade/method/create', [TradeMethodController::class,'store'])->name('admin.method.store');
        Route::post('/trade/method/update/{id}', [TradeMethodController::class,'update'])->name('admin.method.update');
        Route::get('/trade/method/delete/{id}', [TradeMethodController::class,'destroy'])->name('admin.method.delete');
        });

        Route::group(['middleware'=>'permissions:Practise Trade Log'],function(){
            Route::get('/practise/trade/log/datatables/{result}', [PractiseTradeLogController::class,'datatables'])->name('admin.practise.trade.log.datatables');
            Route::get('/practise/trade/log', [PractiseTradeLogController::class,'index'])->name('admin.practise.trade.log.index');
            Route::get('/practise/trade/log/winning', [PractiseTradeLogController::class,'winning'])->name('admin.practise.trade.log.winning');
            Route::get('/practise/trade/log/losing', [PractiseTradeLogController::class,'lose'])->name('admin.practise.trade.log.lose');
            Route::get('/practise/trade/log/draw', [PractiseTradeLogController::class,'draw'])->name('admin.practise.trade.log.draw');
        });

        Route::group(['middleware'=>'permissions:Trade Log'],function(){
            Route::get('/trade/log/datatables/{result}', [TradeLogController::class,'datatables'])->name('admin.trade.log.datatables');
            Route::get('/trade/log', [TradeLogController::class,'index'])->name('admin.trade.log.index');
            Route::get('/trade/log/winning', [TradeLogController::class,'winning'])->name('admin.trade.log.winning');
            Route::get('/trade/log/losing', [TradeLogController::class,'lose'])->name('admin.trade.log.lose');
            Route::get('/trade/log/draw', [TradeLogController::class,'draw'])->name('admin.trade.log.draw');
        });
      ...
      Route::group(['middleware'=>'permissions:General Setting'],function(){
        ...
        Route::post('/holiday-setting', [GeneralSettingController::class,'holidayUpdate'])->name('admin.gs.holiday.update');

        Route::get('/country/datatables', [ManageCountryController::class,'datatables'])->name('admin.country.datatables'); //JSON REQUEST
      ...
      Route::group(['middleware'=>'permissions:SMS Setting'],function(){
