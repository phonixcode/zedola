        ...
        <form class="geniusform" action="{{route('admin.role.store')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="section[]" value="Trade" class="custom-control-input" id="trade">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="section[]" value="Practise Trade Log" class="custom-control-input" id="practise_trade_log">
                    <label class="custom-control-label" for="practise_trade_log">{{__('Practise Trade Log')}}</label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="section[]" value="Trade Log" class="custom-control-input" id="trade_log">
                    <label class="custom-control-label" for="trade_log">{{__('Trade Log')}}</label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="section[]" value="SMS Setting" class="custom-control-input" id="sms_setting">
                    <label class="custom-control-label" for="sms_setting">{{__('SMS Setting')}}</label>
                    </div>
                </div>
              </div>
