                ...
                <div class="row justify-content-center gy-4">
                    <div class="col-12">
                        <div class="card custom--card">
                            <div class="card-header d-flex justify-content-between flex-wrap">
                                <h4 class="card-title">@lang('Create New Ticket')</h4>
                                <a href="{{route('ticket.index') }}" class="btn btn-outline-primary btn-sm">
                                    <i class="os-icon os-icon-list"></i> @lang('All Tickets')
                                </a>
                            </div>
                            <div class="card-body">
                                <form  action="{{route('ticket.store')}}"  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="text-end mb-3">
                                        <a href="javascript:void(0)" class="text-dark addFile"><i class="os-icon os-icon-paperclip"></i> <span class="attachment-text">@lang('Attach Files')</span></a>
                                    </div>
                                    <div class="form-group attachment-wrapper d-none">
                                        <div class="file-upload"></div>
                                        <div id="fileUploadsContainer"></div>
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-primary cmn--btn btn-block" type="submit"><i class="os-icon os-icon-paper-plane"></i>&nbsp;@lang('Submit')</button>
                                    </div>
                                </form>
                            </div>
                        </div>
