        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="currency_rate" name="fiat_access_key"  placeholder="{{ __('Enter currency rate api key') }}" value="{{ $gs->fiat_access_key }}" required>
                </div>
            </div>

            <div class="col-md-12">
                <div class="form-group">
                  <label for="crypto_rate">{{  __('Crypto rate api key')  }}</label>
                  <input type="text" class="form-control" id="crypto_rate" name="crypto_rate_apikey"  placeholder="{{ __('Enter crypto rate api key') }}" value="{{ $gs->crypto_rate_apikey }}" required>
                </div>
            </div>

            <div class="col-md-12">
                <div class="form-group">
                    <label for="inp-profit">{{ __('Trade Profit') }} (%)</label>
                    <input type="text" class="form-control" id="inp-profit" name="trade_profit" placeholder="{{ __('Enter profit percentage') }}" required="" value="{{ $gs->trade_profit }}">
                </div>
            </div>
