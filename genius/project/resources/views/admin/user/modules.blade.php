        ...
        <form class="geniusform" action="{{route('admin.manage.module.update')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="module_section[]" value="Practise Trade" {{ $data->sectionCheck('Practise Trade') ? 'checked' : '' }} class="custom-control-input" id="Practise Trade">
                    <label class="custom-control-label" for="Practise Trade">{{__('Practise Trade')}}</label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="module_section[]" value="Trade" {{ $data->sectionCheck('Trade') ? 'checked' : '' }} class="custom-control-input" id="Trade">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="module_section[]" value="Deposits & Payouts" {{ $data->sectionCheck('Deposits & Payouts') ? 'checked' : '' }} class="custom-control-input" id="deposit">
                  <label class="custom-control-label" for="deposit">{{__('Deposits & Payouts')}}</label>
                  </div>
              </div>
            </div>
