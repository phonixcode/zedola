                    ...
                    <div class="table-responsive mb-2">
                        ...
                        <table class="table table-padded">
                            <thead class="bg-primary text-white">
                                <tr>
                                    <th class="text-white">@lang('Gateway | Transaction')</th>
                                    <th class="text-white">@lang('Initiated')</th>
                                    <th class="text-white">@lang('Amount')</th>
                                    <th class="text-white">@lang('Conversion')</th>
                            ...
                            <tbody>
                                @forelse($deposits as $deposit)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <span class="d-block">1 {{ __($general->cur_text) }} =
                                        ...
                                        <td>
                                            <a href="javascript:void(0)"
                                                class="btn btn--base-outline btn-sm  @if ($deposit->method_code >= 1000) detailBtn @else disabled @endif"
