...
class DepositController extends Controller
{
    public function datatables()
    {
        ...
        return Datatables::of($datas)
                        ...
                        ->addColumn('customer_name',function(Deposit $data){
                            ...
                            return $data != NULL ? $data->name : 'Customer Deleted';
                        })
                        ->addColumn('customer_email',function(Deposit $data){
                            $data = User::where('id',$data->user_id)->first();
                            return $data != NULL ? $data->email : 'Customer Deleted';
                        })
                        ...
                        ->editColumn('status', function(Deposit $data) {
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start">
                              ...
                              <a href="javascript:;" data-toggle="modal" data-target="#statusModal" class="dropdown-item" data-href="'. route('admin.deposits.status',['id1' => $data->id, 'id2' => 'rejected']).'">'.__("Rejected").'</a>
    ...
    public function status($id1,$id2){
        ...
        if($id2 == 'pending'){
            $msg = 'Deposit already in pending';
            return response()->json($msg);
        }
