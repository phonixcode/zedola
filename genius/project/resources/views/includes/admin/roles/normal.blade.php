@if(Auth::guard('admin')->user()->role_id != 0)
  ...
  @if(Auth::guard('admin')->user()->sectionCheck('Trade'))
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#trade" aria-expanded="true" aria-controls="collapseTable">
            <i class="fas fa-globe"></i>
            <span>{{  __('Trade') }}</span>
        </a>
        <div id="trade" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.schedule.index') }}">{{ __('Schedule') }}</a>
                <a class="collapse-item" href="{{ route('admin.method.index') }}">{{ __('Crypto Method') }}</a>
            </div>
        </div>
    </li>
  @endif

    @if(Auth::guard('admin')->user()->sectionCheck('Practise Trade Log'))
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#practise_trade_log" aria-expanded="true" aria-controls="collapseTable">
            <i class="fab fa-pied-piper-alt"></i>
            <span>{{  __('Practise Trade Log') }}</span>
        </a>
        <div id="practise_trade_log" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.practise.trade.log.index') }}">{{ __('All') }}</a>
                <a class="collapse-item" href="{{ route('admin.practise.trade.log.winning') }}">{{ __('Winning') }}</a>
                <a class="collapse-item" href="{{ route('admin.practise.trade.log.lose') }}">{{ __('Losing') }}</a>
                <a class="collapse-item" href="{{ route('admin.practise.trade.log.draw') }}">{{ __('Draw') }}</a>
            </div>
        </div>
    </li>
    @endif

    @if(Auth::guard('admin')->user()->sectionCheck('Trade Log'))
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#trade_log" aria-expanded="true" aria-controls="collapseTable">
            <i class="fas fa-warehouse"></i>
            <span>{{  __('Trade Log') }}</span>
        </a>
        <div id="trade_log" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.trade.log.index') }}">{{ __('All') }}</a>
                <a class="collapse-item" href="{{ route('admin.trade.log.winning') }}">{{ __('Winning') }}</a>
                <a class="collapse-item" href="{{ route('admin.trade.log.lose') }}">{{ __('Losing') }}</a>
                <a class="collapse-item" href="{{ route('admin.trade.log.draw') }}">{{ __('Draw') }}</a>
            </div>
        </div>
    </li>
    @endif
  ...
  <li class="nav-item">
    ...
    <div id="homepage" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="{{ route('admin.counter.index') }}">{{ __('Counter') }}</a>
  ...
  @if(Auth::guard('admin')->user()->sectionCheck('SMS Setting'))
  <li class="nav-item">
