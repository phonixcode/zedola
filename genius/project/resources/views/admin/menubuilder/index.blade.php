            ...
            <div class="row menu-builder">
               <div class="col-lg-12">
                  <ul class="list-group">
                     ...
                     <li class="list-group-item d-flex justify-content-between">
                        <span class="menu-items">{{ __('Service') }}</span>
                        <a data-title="{{ __('Service') }}" data-dropdown="no" data-href="/service" data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                     </li>
                     ...
                     <li class="list-group-item d-flex justify-content-between">
                        ...
                        <a data-title="{{ __('FAQ') }}" data-dropdown="no" data-href="/faq" data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                     </li>
