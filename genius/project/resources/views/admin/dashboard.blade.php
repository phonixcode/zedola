      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card h-100">
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-uppercase mb-1">{{ __('Total Trade Method') }}</div>
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ count($trade_methods) }} </div>
              </div>
              <div class="col-auto">
                <i class="fas fa-fw fa-newspaper fa-2x text-success"></i>
              </div>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ convertedPrice($depositAmount) }}</div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ convertedPrice($withdrawAmount) }}</div>
              </div>
              <div class="col-auto">
                <i class="fas fa-dollar-sign fa-2x text-success"></i>
              </div>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ convertedPrice($withdrawChargeAmount) }}</div>
              </div>
              <div class="col-auto">
                <i class="fas fa-dollar-sign fa-2x text-success"></i>
              </div>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ convertedPrice($bonus) }}</div>
              </div>
              <div class="col-auto">
                <i class="fas fa-dollar-sign fa-2x text-success"></i>
              </div>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ convertedPrice($transfers->sum('amount')) }} </div>
              </div>
              <div class="col-auto">
                <i class="fas fa-dollar-sign fa-2x text-success"></i>
              </div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card h-100">
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-uppercase mb-1">{{ __('Total Trades') }}</div>
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ count($trades) }} </div>
              </div>
              <div class="col-auto">
                <i class="fas fa-clipboard-list fa-2x text-success"></i>
              </div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card h-100">
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-uppercase mb-1">{{ __('Total Trade Amount') }}</div>
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ convertedPrice($trades->sum('amount')) }} </div>
              </div>
              <div class="col-auto">
                <i class="fas fa-clipboard-list fa-2x text-success"></i>
              </div>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col mr-2">
                ...
                <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ convertedPrice($requestAmount) }}</div>
              </div>
              <div class="col-auto">
                <i class="fas fa-dollar-sign fa-2x text-success"></i>
              </div>
