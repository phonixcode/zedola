        ...
        <div class="row pt-5 pb-3 px-3">
            <div class="col-md-6 col-lg-12 col-xl-6">
                <div class="form-group">
                    <label for="title">{{ __('Set Number Of Level For Tradding') }}</label>
                    ...
                    levelHtml += `
                        <div class="lang-area">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" id="level" name="percent[]" placeholder="{{ __('Enter Level Percentage') }}" min="0" step="0.01" value="" required>
                                </div>
                            </div>
                        </div>
                    `;
