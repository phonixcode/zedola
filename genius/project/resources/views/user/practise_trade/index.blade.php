...
<div class="breadcrumb-area bg--body">
    <h3 class="title">@lang('Practise Trade')</h3>
            ...
            <div class="row gy-3 mb-3">
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="number" class="form-control form--control" placeholder="Enter Amount">
                        <button type="button"
...
<script>
    ...
    $(document).ready(function(){
        $(document).on('click','.highLow',function(){
            ...
            $.ajax({
                url: "{{ route('user.practise.trade.store') }}",
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                ...
                success: function (data) {
                    if(data.status == 'success'){
                        ...
                        window.location = '{{ route('user.practise.trade.logs') }}';
