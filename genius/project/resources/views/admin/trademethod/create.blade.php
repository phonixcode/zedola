...
<div class="card">
  <div class="d-sm-flex align-items-center justify-content-between">
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Method') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.method.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
    <ol class="breadcrumb">
  ...
  <div class="col-md-10">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.method.store')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="symbol" name="symbol" placeholder="{{ __('Enter Symbol') }}" value="" required>
          </div>
